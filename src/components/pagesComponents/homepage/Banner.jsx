/* eslint-disable react/no-unescaped-entities */ import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";import { faCalendarDays, faDatabase } from "@fortawesome/free-solid-svg-icons";import BookingModal from "./BookingModal";function Banner() {	return (
	<>
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex flex-row justify-center mb-32 md:mb-48 text-center flex-wrap">
					<div className="bg-transparent relative hover:cursor-pointer p-4 md:p-8 border-[1px] w-full md:w-[200px] my-2 border-gray-200/30 mx-3 hover:border-yellow-300 text-white hover:text-yellow-300 duration-300">
						...
						<button className="absolute bottom-2 left-0 right-0 text-center z-30 animate-pulse hover:scale-110 duration-300 text-green-300">
							<BookingModal />
						</button>
					</div>
					<a
